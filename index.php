            ...
            <div class="tweet-box">
                ...
                <?php foreach ($lesdonnes as $tweet): ?>
                    ...
                    <div class="tweet-p <?php echo $tagColorClass; ?>"  data-color="<?php echo $tweet['couleur']; ?>">
                            ...
                            <p class="text-tweet"><?php echo $tweet['tweet']; ?></p>
        ...
        <div class="post">
            <div class="affichage-post">
                <form method="POST" action="inserer.php" enctype="multipart/form-data">
                    ...
                    <textarea name="montweet" class="contenu-tweet" placeholder="Votre tweet" maxlength="125" rows="3" required></textarea>
            ...
            <img src="img/plus-blanc.png" alt="plus" class="plus">
        </div>
    </div>
